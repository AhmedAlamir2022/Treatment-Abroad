                            ...
                            <div class="card-body">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-md-12"><br>
                                        <form action="{{ route('store.fdprofile') }}" enctype="multipart/form-data" method="post" autocomplete="off">
                                            @csrf
                                            <div class="form-row">
                                                <div class="col">
											...
											<div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <img src="{{ (!empty($userData->doctor_image))? url('upload/ForginDr/'.$userData->doctor_image):url('upload/no_image.jpg') }}" alt="National Dr Image" style="width: 60px; height: 50px;"></td>
