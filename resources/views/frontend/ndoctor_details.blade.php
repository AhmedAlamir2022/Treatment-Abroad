    ...
    <div class="uni-banner-default uni-background-1">
        <div class="container">
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="">N Doctor Details</a></li>
            </ul>
            <!-- End breadcrumbs -->
        </div>
    </div>
                                                ...
                                                <div class="product-info">
                                                    <div class="row">
                                                            ...
                                                            <div id="carousel" class="flexslider thumbnail_product">
                                                                <div id="slider" class="flexslider">
                                                                    <div class="product-slide">
                                                                        <div class="img-slide">
                                                                            <img class="filter2 animated fadeIn shop1 active img-responsive" src="{{ asset($ndoctors->doctor_image) }}" alt="product2">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6 right">
                                                            <h1 class="product_title entry-title">{{$ndoctors->name}}</h1>
                                                            <p class="uni-box-vote">
                                                                ...
                                                                <span>({{$ndoctors->email}})</span>
                                                            </p>
                                                            <div class="description">
                                                                <p>{{$ndoctors->address}}</p>
                                                            </div>
                                                            <!-- .description -->

                                                            <div class="product_meta">
                                                                <span class="posted_in">Hospital:
                                                                    <a rel="tag">({{ $ndoctors->hospitals->title }})</a>
                                                                </span>
                                                            </div>
                                                            <div class="product_meta">
                                                                <span class="posted_in">Specialization:
                                                                    <a rel="tag">({{ $ndoctors->specializations->name  }})</a>
                                                                </span>
                                                            </div>
                                                            <div class="product_meta">
                                                                <span class="posted_in">Contact:
                                                                    <a rel="tag">({{$ndoctors->contact}})</a>
                                                                </span>
                                                            </div>
                                                            <div class="product_meta">
                                                                <span class="posted_in">Gender:
                                                                    <a rel="tag">({{$ndoctors->gender}})</a>
                                                                </span>
                                                            </div>

                                                            <div class="product_meta">
                                                                <span class="posted_in">Naionality:
                                                                    <a rel="tag">({{$ndoctors->nationality}})</a>
                                                                </span>
                                                            </div>

                                                            <div class="product_meta">
                                                                <span class="posted_in">Blood Type:
                                                                    <a rel="tag">({{$ndoctors->bloodtype}})</a>
                                                                </span>
                                                            </div>
                                                            <div class="product_meta">
                                                                <span class="posted_in">Religion:
                                                                    <a rel="tag">({{$ndoctors->religion}})</a>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <!-- .summary -->
                                                                                ...
                                                                                <div id="comments" class="comments-area">
                                                                                    <div class="list-comments">
                                                                                        ...
                                                                                        <ul class="comment-list">
                                                                                            ...
                                                                                            @if($item->ndoctor_id == $ndoctors->id)
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="form-group">
                                                                                                                <div class="col-md-12">
                                                                                                                    ...
                                                                                                                    <input class="form-control" type="hidden" name="ndoctor_id" value="{{$ndoctors->id}}">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group">
                                                                                                                <div class="col-md-12">
