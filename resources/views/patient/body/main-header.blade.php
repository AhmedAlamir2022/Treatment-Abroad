...
<!--=================================
 ...
 <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ route('dashboard') }}"><img src="{{ URL::asset('frontend/images/logo2.png') }}" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}"><img src="{{ URL::asset('frontend/images/logo2.png') }}" alt=""></a>
    </div>
    <!-- Top bar left -->
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                ...
                <img src="{{ (!empty(Auth::user()->user_image))? url('upload/patients/'.Auth::user()->user_image):url('upload/no_image.jpg') }}" alt="avatar">
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('user.profile') }}"><i class="text-warning ti-user"></i>Profile</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('user.change.password') }}"><i class="text-info ti-settings"></i>Change Password</a>
                <div class="dropdown-divider"></div>
