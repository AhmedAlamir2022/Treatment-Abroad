                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
								...
								<button type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                                    Add New Doucments</button><br><br>
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                                        ...
                                        <tbody>
                                            <?php $i = 0; ?>
                                                                ...
                                                                @if($doucmentss->user_id == Auth::user()->id)
                                                                    <?php $i++; ?>
                                                <tr>
                                                    <td>{{ $i }}</td>
																	<td>{{ $doucmentss->doucment }}</</td>
																	<td>@if ($doucmentss->dr_agreement == NULL)
																		<button class="btn btn-warning btn-sm">Dr Didn't Agree Yet</button>
                                                                    ...
                                                                    <td>@if ($doucmentss->admin_agreement == NULL)
                                                                        <button class="btn btn-warning btn-sm">Admin Didn't Agree Yet</button>
																	...
																	<td> <a href="{{route('downloadAttachment2',$doucmentss->doucment)}}" title="Downlod" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="ti-download"></i></a> </td>
                                                </tr>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- add_form -->
                                    <form action="{{route('Doucments.store')}}"  method="post" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-row">
                                            <div class="col">
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <label for="title">Doucment</label>
                                                <input class="form-control" type="file" accept=".pdf,.jpg, .png, image/jpeg, image/png" name="doucment" required>
                                            </div>
                                        </div> <br><hr>
                                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">Add New Doucment</button>
                                    </form>
                                </div>
                            </div>
                        </div>
