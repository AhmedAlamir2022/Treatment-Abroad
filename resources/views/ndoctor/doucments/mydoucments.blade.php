<!DOCTYPE html>
<html lang="en">
    @section('title') Doucments List @stop
    <head>
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                                        ...
                                        <tbody>
                                            <?php $i = 0; ?>
                                                                ...
                                                                @if($doucmentss->doctor_id == Auth::guard('ndoctor')->user()->id)
                                                                    <?php $i++; ?>
																<tr>
																	<td>{{ $i }}</td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="{{route('downloadAttachment',$doucmentss->doucment)}}" title="Downlod" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="ti-download"></i></a>
																	</td>
																</tr>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('Doucments.update','test')}}" method="post" autocomplete="off">
                                                                    {{ method_field('patch') }}
                                                                    @csrf
                                                                        <div class="form-row">
                                                                            <div class="col">
                                                                                ...
                                                                                <select class="form-control select" name="dr_agreement" required>
